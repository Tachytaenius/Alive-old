...
local setColour, rectangle, printf, line = love.graphics.setColor, love.graphics.rectangle, love.graphics.printf, love.graphics.line
...
function renderHUD:draw(targetPlayer)
	...
	if integrity then
		...
		setColour(graphics.barOutlineColour)
